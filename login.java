...
login(){
    ...
    java.awt.Image ii2 = ii1.getImage().getScaledInstance(100,100,Image.SCALE_DEFAULT);
    ...
    ImageIcon iii1 = new ImageIcon(ClassLoader.getSystemResource("icon/backgd1.jpg"));
    java.awt.Image iii2 = iii1.getImage().getScaledInstance(850,480,Image.SCALE_DEFAULT);
